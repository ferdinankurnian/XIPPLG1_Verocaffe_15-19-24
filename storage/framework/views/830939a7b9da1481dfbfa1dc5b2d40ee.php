    ...
    <div class="flex flex-col">
        ...
        <div class="flex w-[800px] h-[525px] bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="w-1/2 p-8">
                ...
                <form action="<?php echo e(route('register.process')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
                ...
                <p class="mt-6 text-center text-sm">
                    Already have account? <a href="<?php echo e(route('login')); ?>" class="text-blue-500 hover:underline">Sign
                        In</a>
                </p>
            </div>
        </div>
...
</html><?php /**PATH /home/iydheko/Projects/XIPPLG1_Verocaffe_15-19-24-main/resources/views/register.blade.php ENDPATH**/ ?>